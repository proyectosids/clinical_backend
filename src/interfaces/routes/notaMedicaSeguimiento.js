...
const getNotasByPacienteUseCase = new GetNotasMedicasSeguimientoByPacienteUseCase(notaRepo);
...
router.post('/paciente/:id_paciente', (req, res, next) => {
  ...
  const payload = Object.assign({}, req.body, { id_paciente: parseInt(req.params.id_paciente, 10) });
...
router.get('/paciente/:id_paciente', (req, res) => notaController.getByPaciente(req, res));
// Obtener nota por ID
